...
<input type="radio" name="service" value="stars">   <font color="#EBFFE9" size=3>Counting Stars★</font><br> 
<input type="radio" name="service" value="moon"> <font color="#EBFFE9" size=3> Talking to the Moon☽</font>  <br>
